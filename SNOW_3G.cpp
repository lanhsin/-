...
#ifdef SNOW_3G_PRINT
//    printf("in ClockLFSRInitializationMode() LFSR_S0 = %08X\n", LFSR_S0);
//    printf("in ClockLFSRInitializationMode() MULalpha = %08X\n", MULalpha( (u8)((LFSR_S0>>24) & 0xff) ));
//    printf("in ClockLFSRInitializationMode() LFSR_S2 = %08X\n", LFSR_S2);
//    printf("in ClockLFSRInitializationMode() LFSR_S11 = %08X\n", LFSR_S11);
//    printf("in ClockLFSRInitializationMode() DIValpha = %08X\n", DIValpha( (u8)( ( LFSR_S11) & 0xff ) ));
    printf("in ClockLFSRInitializationMode() F = %08X\n", F);
    printf("in ClockLFSRInitializationMode() LFSR_S15_before_last_ini = %08X\n\n", LFSR_S15);
#endif
	LFSR_S0 = LFSR_S1;
	LFSR_S1 = LFSR_S2;
	LFSR_S2 = LFSR_S3;
...
#if 0
#ifdef SNOW_3G_PRINT
        printf("in ClockLFSRKeyStreamMode() LFSR_S0 = %08X\n", LFSR_S0);
        printf("in ClockLFSRKeyStreamMode() MULalpha = %08X\n", MULalpha( (u8)((LFSR_S0>>24) & 0xff) ));
        printf("in ClockLFSRKeyStreamMode() LFSR_S2 = %08X\n", LFSR_S2);
        printf("in ClockLFSRKeyStreamMode() LFSR_S11 = %08X\n", LFSR_S11);
        printf("in ClockLFSRKeyStreamMode() DIValpha = %08X\n", DIValpha( (u8)( ( LFSR_S11) & 0xff ) ));
#endif
#endif
	LFSR_S0 = LFSR_S1;
	LFSR_S1 = LFSR_S2;
...
#ifdef SNOW_3G_PRINT
        printf("in GenerateKeystream %dth F = %08X\n", t, F);
        printf("in GenerateKeystream %dth LFSR_S0 = %08X\n", t, LFSR_S0);
#endif
