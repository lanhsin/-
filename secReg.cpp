 ...
 */
inline void 
SEC_SetCipher_Mode(unsigned char value)
{
 ...
 */
inline void 
SEC_SetEEA_KEY(unsigned int *value)
{
 ...
 */
inline void 
SEC_SetEIA_KEY(unsigned int *value)
{
 ...
 */
inline void 
SEC_SetCount(unsigned int value)
{
 ...
 */
inline void 
SEC_SetConfig(unsigned int value)
{
 ...
 */
inline unsigned int 
SEC_GetTx_FIFO_Interrupt_Raw (void)
{
 ...
 */
inline unsigned int 
SEC_GetTx_FIFO_Interrupt_Mask(void)
{
    unsigned int u32Data;
 ...
 */
inline void 
SEC_SetTx_FIFO_Interrupt_Mask(unsigned int value)
{
 ...
 */
inline unsigned int 
SEC_GetTx_FIFO_Interrupt_Status(void)
{
    unsigned int u32Data;
 ...
 */
inline void 
SEC_SetTx_FIFO_Interrupt_Status(unsigned int value)
{
...
inline void 
SEC_SetRx_FIFO_Almost_Empty(unsigned char value)
{
...
inline void 
SEC_SetTx_FIFO_Almost_Full(unsigned char value)
{
 ...
 */
inline void 
SEC_SetRd_Addr(unsigned int value)
{
 ...
 */
inline void 
SEC_SetWr_Addr(unsigned int value)
{
...
#else
unsigned int
sec_virt_to_phys(unsigned int virt)
{
    unsigned int phys; 
